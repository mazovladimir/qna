...
RSpec.describe AnswersController, type: :controller do
  ...
  let(:myquestion2) { create(:question, title: 'more than 10 symbols for user2', user: user2) }
  ...
  describe 'POST #create' do
    ...
    context 'with valid attributes' do
      it 'saves the new answer in the database' do
         expect { post :create, params: { answer: attributes_for(:answer), question_id: myquestion, format: :js } }.to change(myquestion.answers, :count).by(1)
      end
    ...
    context 'with invalid attributes' do
      it 'doesnt save the new answer' do
        expect { post :create, params: { answer: attributes_for(:invalid_answer), question_id: myquestion, format: :js } }.to_not change(myquestion.answers, :count)
      end
